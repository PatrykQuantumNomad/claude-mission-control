...
```bash
node "/Users/patrykattc/work/git/claude-mission-control/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/patrykattc/work/git/claude-mission-control/.claude/get-shit-done/templates/retrospective.md`.
