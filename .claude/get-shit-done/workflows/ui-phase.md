...
```markdown
Read /Users/patrykattc/work/git/claude-mission-control/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/patrykattc/work/git/claude-mission-control/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/patrykattc/work/git/claude-mission-control/.claude/agents/gsd-ui-checker.md for instructions.
