...
```
Task(
  prompt="Read /Users/patrykattc/work/git/claude-mission-control/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/patrykattc/work/git/claude-mission-control/.claude/get-shit-done/templates/VALIDATION.md`
