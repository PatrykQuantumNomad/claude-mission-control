...
The keys live in `.claude/settings.json` (project) or `/Users/patrykattc/work/git/claude-mission-control/.claude/settings.json` (global) — **not** in `.planning/config.json`:
