...
Project root: ${CWD}
Prefer: gsd-sdk query <subcommand> (installed gsd-sdk on PATH). Legacy: node /Users/patrykattc/work/git/claude-mission-control/.claude/get-shit-done/bin/gsd-tools.cjs
