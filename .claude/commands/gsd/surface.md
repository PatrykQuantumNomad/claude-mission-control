...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/patrykattc/work/git/claude-mission-control/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/Users/patrykattc/work/git/claude-mission-control/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/Users/patrykattc/work/git/claude-mission-control/.claude/commands/gsd
AGENTS_DIR=/Users/patrykattc/work/git/claude-mission-control/.claude/agents
```
...
<execution_context>
Surface state file: `/Users/patrykattc/work/git/claude-mission-control/.claude/skills/.gsd-surface.json`
Install profile marker: `/Users/patrykattc/work/git/claude-mission-control/.claude/skills/.gsd-profile`
Engine module: `/Users/patrykattc/work/git/claude-mission-control/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/patrykattc/work/git/claude-mission-control/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
