...
<required_reading>
@/Users/patrykattc/work/git/claude-mission-control/.cursor/get-shit-done/references/user-story-template.md
@/Users/patrykattc/work/git/claude-mission-control/.cursor/get-shit-done/references/spidr-splitting.md
@/Users/patrykattc/work/git/claude-mission-control/.cursor/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/patrykattc/work/git/claude-mission-control/.cursor/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Use `conversational prompting` with options [Re-prompt / Abort]. On Abort, exit cleanly. On Re-prompt, proceed.

## 3. User story prompts

Run three sequential `conversational prompting` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/patrykattc/work/git/claude-mission-control/.cursor/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/patrykattc/work/git/claude-mission-control/.cursor/get-shit-done/references/spidr-splitting.md`. Briefly:
...
Use `conversational prompting` with options [Yes, walk through SPIDR / No, proceed with the story as-is].
...
Use `conversational prompting` with the five options from `spidr-splitting.md` (Spike / Paths / Interfaces / Data / Rules). Each option includes its targeted question as the description so the user can pick by understanding what each axis means.
...
Use `conversational prompting` [Accept / Modify / Reject].
...
Use `conversational prompting` [Apply / Cancel]. On Cancel, exit without writing.
