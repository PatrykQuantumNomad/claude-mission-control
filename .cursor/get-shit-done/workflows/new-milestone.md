...
**Normal mode:** Present via conversational prompting:
```
...
Use template: /Users/patrykattc/work/git/claude-mission-control/.cursor/get-shit-done/templates/research-project/{FILE}
</output>
