...
Call conversational prompting with threat table and options:
...
```
Agent(
  prompt="Read /Users/patrykattc/work/git/claude-mission-control/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/patrykattc/work/git/claude-mission-control/.cursor/get-shit-done/templates/SECURITY.md`
