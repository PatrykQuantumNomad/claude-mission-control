...
**If `EVAL_REVIEW_FILE` non-empty:** Use conversational prompting:
...
```markdown
Read /Users/patrykattc/work/git/claude-mission-control/.cursor/agents/gsd-eval-auditor.md for instructions.
