...
```bash
if [ "$RUNTIME" = "codex" ]; then INSTRUCTION_FILE="AGENTS.md"; else INSTRUCTION_FILE=".cursor/rules/"; fi
```
...
SPIKE_SKILL=$(ls ./.cursor/skills/spike-findings-*/SKILL.md 2>/dev/null | head -1 || true)

# Check for sketch findings skill (project-local)
SKETCH_SKILL=$(ls ./.cursor/skills/sketch-findings-*/SKILL.md 2>/dev/null | head -1 || true)
...
**Otherwise** (Claude runtime with conversational prompting): use multiSelect:
...
Use template: /Users/patrykattc/work/git/claude-mission-control/.cursor/get-shit-done/templates/research-project/STACK.md
</output>
...
Use template: /Users/patrykattc/work/git/claude-mission-control/.cursor/get-shit-done/templates/research-project/FEATURES.md
</output>
...
Use template: /Users/patrykattc/work/git/claude-mission-control/.cursor/get-shit-done/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: /Users/patrykattc/work/git/claude-mission-control/.cursor/get-shit-done/templates/research-project/PITFALLS.md
</output>
...
Use template: /Users/patrykattc/work/git/claude-mission-control/.cursor/get-shit-done/templates/research-project/SUMMARY.md
...
Ask the user how they want to structure the project. Use `conversational prompting` with two options:
...
- `.planning/ROADMAP.md`
- `.planning/STATE.md`
- `$INSTRUCTION_FILE` (`AGENTS.md` for Codex, `.cursor/rules/` for all other runtimes)
...
- [ ] `$INSTRUCTION_FILE` generated with GSD workflow guidance (AGENTS.md for Codex, .cursor/rules/ otherwise)
