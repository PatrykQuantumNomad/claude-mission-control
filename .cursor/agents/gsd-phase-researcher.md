...
@/Users/patrykattc/work/git/claude-mission-control/.cursor/get-shit-done/references/thinking-models-research.md
...
```bash
node "/Users/patrykattc/work/git/claude-mission-control/.cursor/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
...
Use the Write tool to create files — never use `Shell(cat << 'EOF')` or heredoc commands for file creation. This rule applies regardless of `commit_docs` setting.
