...
<required_reading>
Read `/Users/patrykattc/work/git/claude-mission-control/.cursor/get-shit-done/references/ai-frameworks.md` before asking questions. This is your decision matrix.
</required_reading>
...
<interview>
Use a single conversational prompting call with ≤ 6 questions. Skip what the codebase scan or upstream CONTEXT.md already answers.
...
- [ ] Interview completed (≤ 6 questions, single conversational prompting call)
