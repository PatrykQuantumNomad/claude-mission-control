...
- 📋 **v1.2 (or next)** — TBD via `/gsd:new-milestone`
...
Define via `/gsd:new-milestone`. Likely candidates from carried backlog:
...
- **Cost differentiators:** ANLY-06 monthly cost forecast, ANLY-07 per-project cost breakdown card
- **Alert differentiators:** ALRT-13 full anomaly detection, ALRT-14 NL-authored alert rules via Haiku
- **Compare differentiators:** CMPR-06 per-skill latency delta, CMPR-07 "compare with previous session" shortcut
- **Platform / automation backlog:** PLAT-01 Linux/systemd support, AUTO-01..03 NL schedules beyond cron, auto-retry, task dependencies
