...
**Plans:** 5 plans
Plans:
- [ ] 14-01-PLAN.md — Skills router: 4 endpoints (usage, cost dual-path, latency window-CTE, runs) + SSE payload extension + tests
- [ ] 14-02-PLAN.md — Frontend lib plumbing: SkillRange + 6 interfaces + 4 fetchers + 4 hooks + qk entries + OtelEvent attrs_skill_name field
- [ ] 14-03-PLAN.md — TopSkills reactivation (ACTV-04) + tests
...
| 14. Skills API & Page Panels | v1.1 | 0/5 | Not started | - |
