...
// Phase 25 / VIEW-01. The `/cost` route lands NO new filters in Phase 25 —
// only the `schemaVersion` field so future saved views can hydrate against a
// typed shape. The CostByProjectCard 7d/30d toggle stays panel-internal until
// Phase 26/27 per-route adoption migrates it into the search shape.
